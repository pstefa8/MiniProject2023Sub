...
void enterStandbyMode(){
  Wire.beginTransmission(MPL3115A2_ADDRESS); // Start communication with sensor
  Wire.write(MPL3115A2_CIRL_REGI); // Point to control register 1
  Wire.write(0x00); // Write 0x00 to enter standby mode
